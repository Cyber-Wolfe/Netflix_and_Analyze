...
The reason for linear regression with a best-fit line is that it shows a mass amount of data in a classified sense. If the best-fit line skews to one side more we then can assume the site is more biased to said genre espeically if other sites 
